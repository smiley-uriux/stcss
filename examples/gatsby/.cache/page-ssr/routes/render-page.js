...
var _invariant = __webpack_require__(586);
...
var _interopRequireDefault = __webpack_require__(859);
...
var _objectWithoutPropertiesLoose2 = _interopRequireDefault(__webpack_require__(834));

var _assertThisInitialized2 = _interopRequireDefault(__webpack_require__(111));

var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(314));

var _extends2 = _interopRequireDefault(__webpack_require__(527));

var _propTypes = _interopRequireDefault(__webpack_require__(980));

var _react = _interopRequireDefault(__webpack_require__(136));

var _reachRouter = __webpack_require__(924);

var _parsePath = __webpack_require__(762);

exports.parsePath = _parsePath.parsePath;

var _isLocalLink = __webpack_require__(173);

var _rewriteLinkPath = __webpack_require__(564);
...
var _applyTrailingSlashOption = __webpack_require__(516);

var _parsePath2 = __webpack_require__(762);

var _isLocalLink = __webpack_require__(173);

var _ = __webpack_require__(739);
...
var _scrollHandler = __webpack_require__(415);

__webpack_unused_export__ = _scrollHandler.ScrollHandler;

var _useScrollRestoration = __webpack_require__(492);
...
var React = _interopRequireWildcard(__webpack_require__(136));

var _propTypes = _interopRequireDefault(__webpack_require__(980));

var _sessionStorage = __webpack_require__(643);
...
exports.components={"component---src-pages-index-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-index-tsx */ 691).then(__webpack_require__.bind(__webpack_require__, 698))};
...
/* harmony export */ });
var plugins=[{name:'@smiley-uriux/gatsby-plugin-stcss',plugin:__webpack_require__(688),options:{"plugins":[],"mediaQueries":{"mobile":"(max-width: 719px)","tablet":"(min-width: 720px) and (max-width: 991px)","laptop":"(min-width: 992px) and (max-width: 1199px)","desktop":"(min-width: 1200px)"},"breakpoints":["mobile","tablet","laptop","desktop"]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
//   },
// ]
const apis=__webpack_require__(706);function augmentErrorWithPlugin(plugin,err){if(plugin.name!==`default-site-plugin`){// default-site-plugin is user code and will print proper stack trace,
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(136);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(980);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(322);
function HTML(props){return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("html",{...props.htmlAttributes,children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("head",{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("meta",{charSet:"utf-8"}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("meta",{httpEquiv:"x-ua-compatible",content:"ie=edge"}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("meta",{name:"viewport",content:"width=device-width, initial-scale=1, shrink-to-fit=no"}),props.headComponents]}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("body",{...props.bodyAttributes,children:[props.preBodyComponents,/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div",{id:"___gatsby",dangerouslySetInnerHTML:{__html:props.body}},`body`),props.postBodyComponents]})]});}HTML.propTypes={htmlAttributes:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),headComponents:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().array),bodyAttributes:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),preBodyComponents:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().array),body:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().string),postBodyComponents:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().array)};
...
// EXTERNAL MODULE: external "/Users/Work/Code/stcss/node_modules/react/index.js"
var index_js_ = __webpack_require__(136);
var index_js_default = /*#__PURE__*/__webpack_require__.n(index_js_);
// EXTERNAL MODULE: ../../node_modules/prop-types/index.js
var prop_types = __webpack_require__(980);
var prop_types_default = /*#__PURE__*/__webpack_require__.n(prop_types);
// EXTERNAL MODULE: ../../node_modules/gatsby-link/index.js
var gatsby_link = __webpack_require__(739);
// EXTERNAL MODULE: ../../node_modules/gatsby-react-router-scroll/index.js
var gatsby_react_router_scroll = __webpack_require__(802);
// EXTERNAL MODULE: ./.cache/public-page-renderer.js
var public_page_renderer = __webpack_require__(758);
...
var find_path = __webpack_require__(155);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "StContext": () => (/* binding */ StContext),
/* harmony export */   "StProvider": () => (/* binding */ StProvider),
/* harmony export */   "canonizeStCss": () => (/* binding */ canonizeStCss),
/* harmony export */   "isStCss": () => (/* binding */ isStCss),
/* harmony export */   "mergeResponsiveObjs": () => (/* binding */ mergeResponsiveObjs),
/* harmony export */   "mergeStObjs": () => (/* binding */ mergeStObjs),
/* harmony export */   "objForEach": () => (/* binding */ objForEach),
/* harmony export */   "resolveDynamicValue": () => (/* binding */ resolveDynamicValue),
/* harmony export */   "resolveResponsiveValue": () => (/* binding */ resolveResponsiveValue),
/* harmony export */   "resolveStObj": () => (/* binding */ resolveStObj),
/* harmony export */   "resolveStStyle": () => (/* binding */ resolveStStyle),
/* harmony export */   "st": () => (/* binding */ st),
/* harmony export */   "stTest": () => (/* binding */ stTest),
/* harmony export */   "transformValue": () => (/* binding */ transformValue),
/* harmony export */   "useHasMounted": () => (/* binding */ useHasMounted),
/* harmony export */   "useMediaQueries": () => (/* binding */ useMediaQueries),
/* harmony export */   "useSt": () => (/* binding */ useSt)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(136);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(322);
const useSt=()=>(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(StContext);const useHasMounted=()=>{const{0:hasMounted,1:setHasMounted}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{setHasMounted(true);},[]);return hasMounted;};const useMediaQueries=queries=>{const timeout=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();const matchesRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)({});const matchHandler=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(e=>{if(timeout.current){clearTimeout(timeout.current);}const[name]=Object.entries(queries).find(([_,media])=>media===e.media)||[];if(name){matchesRef.current={...matchesRef.current,[name]:e.matches};timeout.current=setTimeout(()=>{setMatches(matchesRef.current);},1);}},[queries]);const{0:matchMediaMatches,1:matchMedias}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>{const matches2={};const matchMedias2=[];Object.entries(queries).forEach(([name,query])=>{if(typeof window==="undefined"){matches2[name]=false;return;}const matchMedia=window.matchMedia(query);matchMedia.addEventListener("change",matchHandler);matchMedias2.push(matchMedia);matches2[name]=matchMedia.matches;});return[matches2,matchMedias2];},[queries,matchHandler]);const{0:matches,1:setMatches}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(matchMediaMatches);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{return()=>{clearTimeout(timeout.current);matchMedias.forEach(q=>{q.removeEventListener("change",matchHandler);});};},[matchMedias,matchHandler]);return matches;};class StyleManager{constructor(config){this.config=config;this.cache=/* @__PURE__ */new Map();this.rules=/* @__PURE__ */new Map();this.sheets=/* @__PURE__ */new Map();this.mqString=(bp,content="")=>{const mediaQuery=this.config.mediaQueries[bp];if(mediaQuery){return`@media ${mediaQuery} {${content}}`;}return content;};this.toString=()=>{let str="";this.rules.forEach((rules,bp)=>{if(rules.length){str+=this.mqString(bp,rules.join("\n"));}});return str;};Object.entries({__global:"",...this.config.mediaQueries}).forEach(([bp,mq])=>{this.rules.set(bp,[]);if(typeof document!=="undefined"){const styleTag=document.createElement("style");styleTag.setAttribute("id",`st-${bp}`);let sheet=document.head.appendChild(styleTag).sheet;if(mq){sheet.insertRule(this.mqString(bp));sheet=sheet.cssRules[0];}this.sheets.set(bp,sheet);}});}getClassesForStyle(style={}){const classes=[];Object.entries(style).forEach(([rule,val])=>{if(Array.isArray(val)){for(let i=0;i<val.length;i++){const bp=this.config.breakpoints[i];classes.push(this.getClassForRule(rule,val[i],bp));}}else{classes.push(this.getClassForRule(rule,val,"__global"));}});return classes;}getClassForRule(stRule,val,bp){var _this$rules$get;const key=`${stRule}|${val}|${bp}`;const cachedClass=this.cache.get(key);if(cachedClass)return cachedClass;const className=`st${this.cache.size.toString(36)}`;this.cache.set(key,className);const[selector,prop]=stRule.split("|");const rule=`${selector.replaceAll("?",`.${className}`)}{${prop.replace(/[A-Z]/g,"-$&").toLowerCase()}:${val}}`;(_this$rules$get=this.rules.get(bp))===null||_this$rules$get===void 0?void 0:_this$rules$get.push(rule);const sheet=this.sheets.get(bp);sheet===null||sheet===void 0?void 0:sheet.insertRule(rule,sheet.cssRules.length);return className;}}const isStCss=config=>{return config.styleManager!==void 0;};const canonizeStCss=config=>{const styleManager=new StyleManager(config);return{...config,styleManager};};const StContext=/*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)({});const StProvider=({children,value})=>{const{mediaQueries:mqs,breakpoints}=value;const mediaQueries=useMediaQueries(mqs);const bpIndex=breakpoints.findIndex(bp=>mediaQueries[bp]);return/* @__PURE__ */(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(StContext.Provider,{value:{...value,bpIndex,mediaQueries},children});};const resolveDynamicValue=(value,args)=>{return typeof value==="function"?value(args):value;};const objForEach=(obj,args,cb)=>{if(obj===void 0)return;if(typeof obj==="function")return objForEach(obj(args),args,cb);if(obj&&typeof obj==="object"){Object.entries(obj).forEach(([key,val])=>{if(typeof val==="function"){val=val(args);}cb([key,val]);});}};const transformValue=(prop,val,transformers,result={})=>{let transformed=false;for(const transformer of transformers){const r=transformer(prop,val);if(r!==void 0){transformed=true;if(r&&typeof r==="object"){Object.entries(r).forEach(([tProp,tVal])=>{transformValue(tProp,tVal,transformers.filter(t=>t!==transformer),result);});break;}else{result[prop]=r;}}}if(!transformed){result[prop]=val;}return result;};const resolveStStyle=(style,args,transformers,sel="?",result={})=>{if(style){objForEach(style,args,([key,val])=>{if(typeof val==="object"){if(key==="&"){const nestedSel=val[0].split(",");return nestedSel.forEach(ns=>{let newSel=ns.replaceAll("&",sel);if(!newSel.includes("?")){newSel="? "+newSel;}resolveStStyle(val[1],args,transformers,newSel,result);});}else if(!Array.isArray(val)){return resolveStStyle(val,args,transformers,sel+key,result);}}if(transformers){let transformedValue;if(Array.isArray(val)){const transformedValues=val.map(v=>transformValue(key,v,transformers));transformedValue=transformedValues.reduce((obj,v)=>{Object.entries(v).forEach(([tProp,tVal])=>{if(!obj[tProp]){obj[tProp]=[];}obj[tProp].push(tVal);});return obj;},{});}else{transformedValue=transformValue(key,val,transformers);}Object.entries(transformedValue).forEach(([tProp,tVal])=>{result[`${sel}|${tProp}`]=tVal;});}else{result[`${sel}|${key}`]=val;}});}return result;};function resolveStObj(obj,bpIndex,args={}){const result={};objForEach(obj,args,([prop,value])=>{if(Array.isArray(value)){let v;for(let i=bpIndex+1;i--;i>=0){if(value[i]!==void 0){v=value[i];break;}}if(v!==null&&v!==void 0){result[prop]=v;}}else{result[prop]=value&&typeof value==="object"?resolveStObj(value,bpIndex,args):value;}});return result;}const mergeStObjs=(bpIndex,objs,args={})=>{const mergedObj={};for(const obj of objs){Object.assign(mergedObj,resolveStObj(obj,bpIndex,args));}return mergedObj;};const resolveResponsiveValue=(val,bpIndex)=>{if(!Array.isArray(val))return val;for(let i=bpIndex;i>=0;i--){if(val[i]!==void 0){return val[i];}}return null;};const mergeResponsiveObjs=(objs,bpCount=4)=>{const result={};objs.forEach(obj=>{Object.entries(obj||{}).forEach(([key,val])=>{const prevVal=result[key];if(Array.isArray(val)){result[key]=[];for(let i=0;i<bpCount;i++){result[key][i]=resolveResponsiveValue(val,i);if(result[key][i]===null){result[key][i]=resolveResponsiveValue(prevVal,i);}}if(result[key].every((v,_,arr)=>v===arr[0])){if(result[key][0]===null||result[key][0]===void 0){delete result[key];}else{result[key]=result[key][0];}}}else if(val!==void 0&&val!==null){result[key]=val;}});});return result;};const st=()=>{return function st2(options){const{el,defaultAttrs=[],defaultProps=[],className=[],forwardAttrs=[],forwardCss=[],css=[],render}=options;const defaultAttrsArray=Array.isArray(defaultAttrs)?defaultAttrs:[defaultAttrs];const defaultPropsArray=Array.isArray(defaultProps)?defaultProps:[defaultProps];const defaultCssArray=Array.isArray(css)?css:[css];const classNameArray=Array.isArray(className)?className:[className];const St=function St2({children,as,attrs,css:css2,className:className2,...props}){const{bpIndex,styleManager,breakpoints}=useSt();const forwardedAttrs={};const forwardedCss={};if(forwardAttrs.length||forwardCss.length){Object.keys(props).forEach(prop=>{if(forwardAttrs.includes(prop)){forwardedAttrs[prop]=props[prop];}else if(forwardCss.includes(prop)){forwardedCss[prop]=props[prop];}});}const mergedProps=mergeStObjs(bpIndex,[...defaultPropsArray,props]);const mergedAttrs=mergeStObjs(bpIndex,[...defaultAttrsArray,attrs,forwardedAttrs],mergedProps);const mergedCss=mergeResponsiveObjs([...defaultCssArray,css2,forwardedCss].map(style=>resolveStStyle(style,mergedProps)),breakpoints.length);const cssClassNames=styleManager.getClassesForStyle(mergedCss);const classNames=[...classNameArray.map(c=>resolveDynamicValue(c,mergedProps)),className2,...cssClassNames].filter(Boolean);if(classNames.length){mergedAttrs["className"]=classNames.join(" ");}if(!render){return/*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(as||el,mergedAttrs,children);}return render({C:as||el,attrs:{children,...mergedAttrs},...mergedProps});};St.extend=()=>{return function stExtend(options2){const extendedCss=options2.css||[];return st2({el:options2.as||el,className:options2.className,forwardAttrs:options2.forwardAttrs,forwardCss:options2.forwardCss,defaultAttrs:[...defaultAttrsArray,options2.defaultAttrs],defaultProps:[...defaultPropsArray,options2.defaultProps],css:[...defaultCssArray,...(Array.isArray(extendedCss)?extendedCss:[extendedCss])],render});};};return St;};};const stTest=()=>options=>{return options;};
...
var _reactJsxRuntime=__webpack_require__(322);// eslint-disable-next-line @typescript-eslint/no-unused-vars
//import * as React from 'react';
//import type { GatsbySSR } from 'gatsby';
// eslint-disable-next-line @typescript-eslint/no-var-requires
const{canonizeStCss,isStCss,StProvider}=__webpack_require__(477);let stCss;exports.wrapRootElement=({element},{plugins:_plugins,...stCssOrConfig})=>{stCss=isStCss(stCssOrConfig)?stCssOrConfig:canonizeStCss(stCssOrConfig);return/*#__PURE__*/_reactJsxRuntime.jsx(StProvider,{value:stCss,children:element});};// eslint-disable-next-line @typescript-eslint/no-explicit-any
exports.onRenderBody=({setHeadComponents})=>{setHeadComponents([/*#__PURE__*/_reactJsxRuntime.jsx("style",{dangerouslySetInnerHTML:{__html:stCss.styleManager.toString()}},"stcss")]);};
...
var invariant = __webpack_require__(586);
var invariant_default = /*#__PURE__*/__webpack_require__.n(invariant);
// EXTERNAL MODULE: ./.cache/react-lifecycles-compat.js
var react_lifecycles_compat = __webpack_require__(465);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f=__webpack_require__(136),k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
...
"use strict";
module.exports = require("/Users/Work/Code/stcss/examples/gatsby/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/Work/Code/stcss/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/Work/Code/stcss/node_modules/react/index.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-e99a71cd275afe9295bc.js"],"app":["/app-69d5bd17460470a938ab.js"],"component---src-pages-index-tsx":["/component---src-pages-index-tsx-6c4af5306a970c894f5c.js"]}');
...
/******/ 			return "" + "component---src-pages-index-tsx" + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/* global HAS_REACT_18 */const React=__webpack_require__(136);const path=__webpack_require__(423);const{renderToString,renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(72);const{ServerLocation,Router,isRedirect}=__webpack_require__(924);const merge=__webpack_require__(714);const{StaticQueryContext}=__webpack_require__(886);const fs=__webpack_require__(534);const{WritableAsPromise}=__webpack_require__(126);const{RouteAnnouncerProps}=__webpack_require__(133);const{apiRunner,apiRunnerAsync}=__webpack_require__(485);const asyncRequires=__webpack_require__(849);const{version:gatsbyVersion}=__webpack_require__(872);const{grabMatchParams}=__webpack_require__(155);const chunkMapping=__webpack_require__(804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
const{join}=path.posix;// const testRequireError = require("./test-require-error")
// For some extremely mysterious reason, webpack adds the above module *after*
// this module so that when this code runs, testRequireError is undefined.
// So in the meantime, we'll just inline it.
const testRequireError=(moduleName,err)=>{const regex=new RegExp(`Error: Cannot find module\\s.${moduleName}`);const firstLine=err.toString().split(`\n`)[0];return regex.test(firstLine);};let Html;try{Html=__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../src/html'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));}catch(err){if(testRequireError(`../src/html`,err)){Html=__webpack_require__(880);}else{throw err;}}Html=Html&&Html.__esModule?Html.default:Html;const getPageDataPath=path=>{const fixedPagePath=path===`/`?`index`:path;return join(`page-data`,fixedPagePath,`page-data.json`);};const getPageDataUrl=pagePath=>{const pageDataPath=getPageDataPath(pagePath);return`${""}/${pageDataPath}`;};const getStaticQueryPath=hash=>join(`page-data`,`sq`,`d`,`${hash}.json`);const getStaticQueryUrl=hash=>`${""}/${getStaticQueryPath(hash)}`;const getAppDataUrl=()=>`${""}/${join(`page-data`,`app-data.json`)}`;const createElement=React.createElement;const sanitizeComponents=components=>{const componentsArray=[].concat(components).flat(Infinity).filter(Boolean);return componentsArray.map(component=>{// Ensure manifest is always loaded from content server
...
global.unsafeBuiltinUsage=[];try{let bodyHtml=``;let headComponents=[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("meta",{name:"generator",content:`Gatsby ${gatsbyVersion}`},`generator-${gatsbyVersion}`)];let htmlAttributes={};let bodyAttributes={};let preBodyComponents=[];let postBodyComponents=[];let bodyProps={};function loadPageDataSync(_pagePath){if(_pagePath===pagePath){// no need to use fs if we are asking for pageData of current page
